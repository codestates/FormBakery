...
const Viewform = () => {
  ...
  return (
    <div className="bg-subMain w-screen min-h-screen -mt-3 py-4">
                          ...
                          <FormControlLabel
                            ...
                            control={
                              <Radio
                                style={{
                                  color:
                                    selectedRadioObject.value === value.uuid
                                      ? `${state.color},1)`
                                      : undefined,
                                }}
                              />
                            ...
                            control={
                              <Checkbox
                                ...
                                onChange={() => {
                                  ...
                                  const idxx = newCheckList.findIndex(
                                    (xx) => xx.uuid === value.uuid
                                  );
                                  newCheckList[idxx] = {
                                    ...newCheckList[idxx],
      ...
      <Alert
        title={countAnswer !== 1 ? "답변 제출" : "답변 제출"}
        subTitle={
          countAnswer !== 1
            ? "이미 답변을 제출 하셨습니다."
            : "답변을 제출 하였습니다."
