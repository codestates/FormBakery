      ...
      {pageState === "question" ? (
        <>
          ...
          >
            미리보기가 가능합니다.
            <br />
            옵션을 섞고싶은 카드를 선택한 뒤 Ctrl + Enter를 입력하시면 옵션을
            무작위로 섞을 수 있습니다.
          </div>
        </>
      ) : (
        <div style={{ width: 768, margin: "0 auto", position: "relative" }}>
          ...
          <div className="bg-white border-1 rounded-lg py-4 px-6 mt-3">
            ...
            <div className="mt-6">
              <div className="bg-slate-100 rounded-md px-1 py-2 text-sm mt-2">
                안녕하세요. 저는 박남수 입니다. 잘 부탁드립니다.
              </div>
              <div className="bg-slate-100 rounded-md px-1 py-2 text-sm mt-2">
                세진입니다~ 프론트가 1명뿐이지만 열심히 해보겠습니다. ㅠㅠㅠ
              </div>
              <div className="bg-slate-100 rounded-md px-1 py-2 text-sm mt-2">
                안녕하세요 정수비입니다~~ 다같이 화이팅해서 잘 마무리해요!
              </div>
            </div>
          </div>
          <div className="bg-white border-1 rounded-lg py-4 px-6 mt-3">
